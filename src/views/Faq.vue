  ...
  locale.value === "en"
    ? [
        ...
        },
        {
          ...
          answer:
            "Co-ownership typically involves a smaller group sharing one aircraft directly, while fractional ownership is a more structured model with defined shares, hours, and management frameworks.",
        },
        {
