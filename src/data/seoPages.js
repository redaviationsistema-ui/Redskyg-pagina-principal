...
const localeImageOverrides = {
  es: {
    "/images/blog/Blog1.png": "/images/Home/home11.jpg",
    "/images/blog/Blog2.png": "/images/Home/home2.jpg",
    "/images/blog/Blog3.png": "/images/Service/IMG_3074.jpg",
    "/images/blog/About.png": "/images/Home/home11.png",
    "/images/Home/home10.png": "/images/Home/IMG_3084.jpg",
    "/images/About/About10.png": "/images/About/about3.png",
    "/images/CompraVenta/Compraventa2.png": "/images/CompraVenta/Compraventa1.png",
  },
};
...
const localizeImagePath = (imagePath, locale = "es") =>
  localeImageOverrides[locale]?.[imagePath] || imagePath;

const localizeSeoMedia = (page, locale = "es") => ({
  ...page,
  heroImage: page.heroImage ? localizeImagePath(page.heroImage, locale) : page.heroImage,
  sections: (page.sections || []).map((section) => ({
    ...section,
    image: section.image ? localizeImagePath(section.image, locale) : section.image,
  })),
});
...
const getAutogeneratedEnglishHeroIntro = (page, title) => {
  switch (page.category) {
    case "Paginas por Rutas":
      return `${title} is built for travelers who already know their origin and destination and need a clearer path to private flight planning.`;
    case "Paginas por Ciudad":
      return `${title} is designed for travelers searching for private aviation options in this market and looking for a clearer way to request a quote.`;
    case "Paginas de Intencion de Compra":
      return `${title} is built for visitors who are already close to requesting a quote and need a more direct next step.`;
    ...
    case "Blog SEO":
      return `${title} is a practical article built to connect early research with a more informed private aviation conversation.`;
    default:
      return `${title} is designed to explain what matters and help visitors move toward a clearer private aviation quote in Mexico.`;
  }
};
  ...
  switch (page.category) {
    case "Paginas por Rutas":
      return {
        ...
        text: "Share your route, date, and passenger count to receive a quote aligned with the mission profile and schedule.",
      };
    case "Paginas por Ciudad":
      return {
        title: `Request private flight options for ${title}`,
        text: "Share your route, timing, and passenger details to receive flight options for departures from this market.",
      };
    case "Paginas de Intencion de Compra":
      return {
        title: "Request a clearer quote",
        text: "Share the core trip details so the team can review the request and respond with a more useful quote.",
      };
    case "Paginas Informativas":
    case "Blog SEO":
      return {
        title: `Speak with an advisor about ${title}`,
        text: "Share your route or travel objective and receive guidance aligned with your timing, passenger count, and operating needs.",
      };
    default:
      return {
        title: `Learn more about ${title}`,
        text: "Share your route, passengers, and preferred timing so you can receive a quote that fits the trip.",
      };
  }
};
...
const buildEnglishAutogeneratedSections = ({
  ...
  const categoryCopy = {
    "Paginas Principales": {
      benefitTitle: benefitTitle || "A clearer page for direct charter demand",
      ...
      benefitParagraphs: [
        `${description} This page should explain the service clearly, show what the client receives, and create a more direct path from search intent to quote.`,
      ...
      operationTitle: operationTitle || "How this type of request is usually evaluated",
      ...
      operationParagraphs: [
        operationText || "The strongest private aviation pages help the client understand what changes from one trip to another and why the quote should be reviewed around the actual mission.",
    ...
    "Paginas por Rutas": {
      benefitTitle: benefitTitle || `Why ${title} is a relevant route search`,
      ...
      benefitParagraphs: [
        `${description} Route pages work best when they explain why this city pair matters, what type of traveler usually searches it, and how private aviation improves schedule control.`,
      ...
      operationParagraphs: [
        operationText || "A stronger route page helps the traveler understand why the quote depends on the actual mission rather than a generic range or a single aircraft assumption.",
    ...
    "Paginas Informativas": {
      ...
      benefitSummary: `Searches for ${primaryKeyword} usually come from readers who need clearer guidance before they are ready to request a quote.`,
      ...
      benefitParagraphs: [
        ...
        benefitText || `That matters for ${audienceLabel}, because stronger educational content builds trust before the conversation moves into quoting.`,
      ],
      operationTitle: operationTitle || "How this topic supports a better quote",
      operationSummary: "The best informational pages explain what changes from one mission to another and why clearer details lead to a more useful quote.",
  ...
  return [
    ...
    },
    {
      ...
      highlights: ["Share route details", "Define timing", "Request a tailored quote"],
      paragraphs: [
        ...
        "A better-structured request builds more trust because it gives both sides a clearer starting point for the quote.",
      ],
    },
  ];
};
    ...
    ? [
        {
          ...
          answer:
            "Share your route, preferred timing, passenger count and whether the trip is one-way or round-trip. That makes it easier to evaluate availability and prepare a quote with the right aircraft profile.",
        },
        {
          question: `What usually matters most when evaluating ${title.toLowerCase()}?`,
          answer:
            "The main factors are route profile, schedule flexibility, airport access, passenger requirements and the service profile required. Those points shape the quote more than a generic public rate.",
        },
        {
    ...
    return [
      {
        ...
        paragraphs: [
          `${title} is not just a descriptive topic. If you arrive through this search, you are usually closer to taking action than someone who is only starting to research. ${intro} The goal here is simple: explain what the service means, whether it fits your trip and why a private aviation quote should be reviewed according to route, timing and service expectations.`,
      ...
      },
      {
        ...
        paragraphs: [
          ...
          `A clearer quote process also builds more trust. Instead of leaving with only a general idea, you get a more useful path toward a tailored quote that actually fits the trip.`,
        ],
      },
    ];
  }
...
const createPage = ({
  ...
  return {
    ...
    heroIntroByLocale: {
      es: intro,
      en: `If you are looking for ${title.toLowerCase()}, this page explains how it works, what matters most, and how to move toward a clearer private aviation quote in Mexico.`,
    },
    audience,
    whatsappHref,
...
export const seoPages = [
  ...
  },
  {
    ...
    sectionsByLocale: {
      en: [
        ...
        },
        {
          ...
          image: "/images/blog/Blog2.png",
          summary:
            "A tailored quote creates more value than a generic number because it reflects the route, aircraft profile, availability, and expected service level.",
          paragraphs: [
            ...
            "A stronger quote also improves comparison. Instead of receiving a vague answer, the user gets more practical commercial guidance and can evaluate options with better operational context. That strengthens trust, improves lead quality, and makes it easier for the commercial team to respond with a serious quote from the first exchange.",
          ],
        },
        {
        ...
        {
          title: "Next step to request your quote",
          kicker: "Conversion",
          image: "/images/Home/home11.png",
          summary:
            "The final goal is to move from research into a clear quote with commercial and operational follow-up.",
          paragraphs: [
    ...
    ctaByLocale: {
      en: {
        ...
        text:
        "Share the key details of your trip and receive a quote built around your route, passengers, and preferred timing.",
      },
    },
    faqs: [
      {
      ...
      en: [
        {
          ...
          answer:
            "Usually route, date, passenger count, and a preferred departure window are enough to begin. If there are baggage or agenda restrictions, adding them helps refine the quote.",
        },
        {
  ...
  createPage({
    ...
    ctaText:
      "Share your route, date, and passenger count to receive a tailored charter quote.",
  ...
  createPage({
    ...
    ctaText:
      "Share your itinerary and receive a tailored quote for private jet travel in Mexico.",
...
const englishSectionTemplates = {
  "Paginas Principales": [
    ...
    {
      title: "A clearer path from interest to quote",
      text:
    ...
    },
    {
      ...
      text:
        "It answers practical charter questions with clearer language and gives travelers a more direct path to evaluate private aviation in Mexico.",
    },
  ],
  "Paginas por Rutas": [
    {
      ...
      text:
        "This route page is built for travelers who already know their origin and destination and are closer to requesting a private flight quote.",
    },
    {
    ...
    },
    {
      title: "Why this page matters",
      text:
        "It answers route-specific questions with clearer language and gives travelers a more direct path to evaluate private aviation in Mexico.",
    },
  ],
  "Paginas por Ciudad": [
    {
    ...
    },
    {
      ...
      text:
        "The page can communicate response speed, route flexibility, and tailored quotes for users searching from a defined city or metro area.",
    },
    {
      title: "Why this page matters",
      text:
        "It answers city-specific questions with clearer language and gives travelers a more direct path to evaluate private aviation in Mexico.",
    },
  ],
  "Paginas Informativas": [
    {
    ...
    },
    {
      title: "Why this page matters",
      text:
        "It answers practical questions with clearer language and gives readers a more direct path to evaluate private aviation in Mexico.",
    },
  ],
  "Paginas de Intencion de Compra": [
    {
    ...
    },
    {
      ...
      text:
        "The goal is to reduce friction, ask for only the right details, and move the visitor quickly toward a tailored quote.",
    },
    {
      title: "Why this page matters",
      text:
        "It answers buying-stage questions with clearer language and gives visitors a more direct path to request private aviation in Mexico.",
    },
  ],
  "Blog SEO": [
    {
    ...
    },
    {
      title: "Why this page matters",
      text:
        "It answers practical questions with clearer language and gives readers a more direct path from research to inquiry.",
    },
  ],
};
...
const pageTranslations = {
  "vuelos-privados-mexico": {
    en: {
      ...
      description:
        "Request private flights in Mexico with tailored coordination, nationwide coverage, and executive routes for corporate and private clients.",
      heroIntro:
      ...
      sections: [
        {
          ...
          paragraphs: [
            "The cost of a private flight in Mexico is not based on one flat public rate because every mission changes according to route, aircraft category, total flight time, schedule, availability, and passenger needs. A short executive route inside the country is priced very differently from a leisure departure to a beach destination, a cross-border movement, or a more complex itinerary that involves repositioning, waiting times, and airport coordination. That is why strong SEO content around private flights should explain the logic behind quoting instead of publishing generic numbers that do not reflect real operations.",
            "Other variables also matter, including aircraft positioning, desired departure time, baggage profile, passenger count, overnight crew requirements, private terminal coordination, and the level of operational support expected. In corporate travel, timing and schedule continuity usually carry more weight. In leisure travel, privacy, comfort, and flexibility may be the priority. The best way to guide the reader is to explain that a professional quote is built around the actual mission so the quote starts from a realistic commercial and operational basis.",
          ],
        },
        {
        ...
        },
        {
          ...
          image: "/images/blog/About.png",
          summary:
            "The best quote starts with a clear route, date, passenger count, and a defined operational context so the response is actually useful.",
          highlights: ["Share your route", "Define passengers", "Move to quote"],
          paragraphs: [
            "The right way to quote a private flight starts with sharing a clear route, date, passenger count, trip type, and any schedule restriction or operational detail that matters. The more defined the scenario is, the easier it becomes to receive a quote that actually fits the mission.",
            "To address that buying intent more directly, the next step should point to https://redskyg.com/landing/ and focus on the quoting process. From here, the user can move into a more transactional flow that explains what details to share, how a quote is structured, and why a personalized quote is more useful than a generic public number. That link helps split intent intelligently between the main landing page and a dedicated conversion page without weakening the authority of the primary URL.",
          ],
          href: "https://redskyg.com/landing/",
          linkLabel: "Go to the page about quoting a private flight",
        },
      ],
      ctaTitle: "Request your private flight quote",
      ctaText:
        "Share your route and schedule to receive personalized attention and a quote aligned with your travel needs.",
      faqs: [
        {
        ...
        },
        {
          ...
          answer:
            "Not always. In private aviation, operational variables change significantly, so a tailored quote is usually more useful than a generic number without route and mission context.",
        },
      ],
    },
  },
  landing: {
    en: {
      title: "How to Quote a Private Flight",
      description:
        "Learn how to quote a private flight with the right details so you can receive a clearer and more useful quote.",
      heroIntro:
        "If you are already evaluating a private departure, here you can see what information to share so the quote you receive is clearer and more useful.",
      sections: [
        {
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "A better-built quote also helps compare alternatives with more clarity and make decisions with stronger commercial and operational context.",
          ],
        },
        {
          title: "Next step to request your quote",
          paragraphs: [
            ...
            "The goal is to turn your need into a clear quote instead of leaving you with ambiguous information or weak guidance.",
          ],
        },
      ],
      ctaTitle: "Request a well-structured quote",
      ctaText:
        "Share the key details of your trip and receive a quote based on your route, passenger count, and timing.",
      audience: ["Quote-ready clients", "Hot leads", "Quoting"],
      faqs: [
        {
          question: "What do I need to quote a private flight?",
          answer:
            "Usually route, date, passenger count, and a preferred schedule are enough to begin. If there are baggage or agenda restrictions, adding them helps refine the quote.",
        },
        {
          question: "Can I request a quote without knowing the exact aircraft?",
          answer:
  ...
  "renta-avion-privado-mexico": {
    en: {
      ...
      description:
        "Private aircraft rental in Mexico for executive, family, and high-demand routes with tailored quoting.",
    },
  },
  "renta-avion-privado": {
    en: {
  ...
  "jet-privado-cdmx-cancun": {
    ...
    en: {
      ...
      sections: [
        ...
        {
          title: "The quote should match the mission",
          summary:
            "Aircraft category, baggage profile, schedule, and departure airport all shape which quote makes the most sense for this route.",
          highlights: ["Light jet", "Midsize jet", "Heavy jet"],
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "The most useful next step is to share the route, date, and passenger count so the quote can be built with better context.",
          ],
        },
      ],
      ctaTitle: "Request your quote for CDMX to Cancun",
      ctaText:
        "Share the route, date, and passenger count to receive a private aviation quote with clearer commercial and operational context.",
  ...
  "jet-privado-cdmx-monterrey": {
    en: {
      ...
      ctaText:
        "Receive a tailored quote for your private flight on this executive route.",
  ...
  "jet-privado-cdmx-guadalajara": {
    ...
    en: {
      ...
      seoDescription:
        "Request private flights from Mexico City to Guadalajara with direct coordination, privacy, and a quote tailored to the route.",
      description:
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "A stronger quote explains why a certain cabin or category makes sense for the route instead of relying on generic assumptions.",
          ],
        },
        {
          title: "A more structured quote for the route",
          summary:
            "The quality of the quote depends on having a clear route, travel date, passenger count, and enough operating context to evaluate the mission properly.",
          highlights: ["Defined route", "Operating context", "Private quote"],
          paragraphs: [
            ...
            "That is why the best next step is to request a private quote with the route, date, and passenger details already defined.",
          ],
        },
        {
          title: "Benefits",
      ...
      ctaText:
        "Share your route, date, and passenger count to receive a private quote with clearer commercial and operational context.",
      ...
      faqs: [
        ...
        {
          question: "What does this executive charter quote include?",
          answer:
        ...
        },
        {
          ...
          answer:
            "The earlier the route is shared, the easier it is to build a clearer quote around the trip.",
        },
      ],
    },
  },
  ...
  "jet-privado-monterrey-cancun": {
    en: {
      ...
      ctaText:
        "Ask for a quote with aircraft options and availability for this route.",
  ...
  "vuelo-privado-cdmx-tijuana": {
    en: {
      ...
      ctaText:
        "Ask for route options and receive an executive quote tailored to your timing.",
  ...
  "vuelo-privado-cancun-miami": {
    en: {
      ...
      ctaText:
        "Share your travel date, passengers, and preferences to receive a tailored quote.",
  ...
  "renta-jet-privado-cdmx": {
    en: {
      ...
      description:
        "Private jet rental in Mexico City for executive travel, direct transfers, and private flights with tailored quoting.",
    },
  },
  "renta-jet-privado-toluca": {
    en: {
  ...
  "jet-privado-toluca": {
    en: {
      ...
      description:
        "Private jet service in Toluca with executive departures, attentive coordination, and tailored quoting for private flights from central Mexico.",
    },
  },
  "renta-jet-privado-monterrey": {
    en: {
  ...
  "renta-jet-privado-guadalajara": {
    en: {
      ...
      description:
        "Request private jet rental in Guadalajara for executive, corporate, and private flights with dedicated coordination.",
    },
  },
  "renta-jet-privado-cancun": {
    en: {
  ...
  "jet-privado-cancun": {
    en: {
      ...
      description:
        "Private jet service in Cancun for executive travel, private transfers, and executive departures with tailored quoting.",
    },
  },
  "renta-jet-privado-los-cabos": {
    en: {
  ...
  "como-contratar-vuelo-privado": {
    en: {
      ...
      description:
        "Learn how to book a private flight in Mexico, which details matter first, and how to request a clearer quote.",
    },
  },
  "que-incluye-jet-privado": {
    en: {
  ...
  "cotizar-vuelo-privado-mexico": {
    en: {
      ...
      description:
        "Request a private flight quote in Mexico with a clearer process, stronger route context, and a quote tailored to the trip.",
    },
  },
  "solicitar-jet-privado": {
    en: {
      ...
      description:
        "Request a private jet in Mexico with route-based guidance, aircraft coordination, and a clearer path to a tailored quote.",
    },
  },
  "charter-privado-mexico-cotizacion": {
    en: {
  ...
  "precio-vuelo-privado-por-hora": {
    en: {
      ...
      ctaTitle: "Request a well-structured private flight quote",
      ctaText:
  ...
  "renta-de-aviones-privados": {
    en: {
      ...
      heroIntro:
        "Private aircraft rental designed for travelers who want a clearer process, more direct coordination, and a quote built around the actual trip.",
      ctaTitle: "Quote your private jet",
      ctaText:
        "Send your route, date, and passenger count to receive a tailored quote.",
    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          title: "Why this page matters",
          text:
            "It answers practical questions with clearer language and gives travelers a more direct path to evaluate private aviation in Mexico.",
        },
      ],
  ...
  "diferencias-vuelo-privado-y-comercial": {
    en: {
      ...
      ctaTitle: "Compare and request your quote",
      ctaText:
        "If private aviation already feels like the right fit, request a tailored quote for your route and schedule.",
...
export const resolveSeoPageForLocale = (page, locale = "es") => {
  ...
  if (!localized && locale === "es") {
    return localizeSeoMedia(normalizeSpanishDisplayObject(page), locale);
  }
  if (!localized) {
  ...
  return localizeSeoMedia(
    locale === "es" ? normalizeSpanishDisplayObject(resolvedPage) : resolvedPage,
    locale
  );
};
